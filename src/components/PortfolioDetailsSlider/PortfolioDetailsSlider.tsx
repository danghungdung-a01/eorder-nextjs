...
export default function PortfolioDetailsSlider({ props }: Props) {
  const swiperTestimonialRefss = useRef<any>(null);
  return (
          ...
          {(props ?? []).map((item, index) => {
            return (
              <SwiperSlide key={index}>
                <Image width={1000} height={1000} src={item?.img} alt="portfolio" className="img-fluid" />
              </SwiperSlide>
            );
          })}
        </Swiper>
        <div className="ak-swiper-controll-4">
          <div className="ak-swiper-navigation-wrap-4">
            ...
            >
              ...
              <div className="absolute translate-x-[0px]">
                <svg
                  width="40"
                  height="55"
                  viewBox="0 0 54 52"
