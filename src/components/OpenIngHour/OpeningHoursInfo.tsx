...
export default function OpeningHoursInfo({ typeTwo }: OpeningHoursInfoProps) {
  ...
  return (
    <>
      ...
      <div className={typeTwo ? "container mx-auto md:px-6 px-4" : "ak-bg-secendary"}>
