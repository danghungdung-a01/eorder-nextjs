...
import { scrollButton } from "../../lib/helper/main";
...
export default function HeroSilder() {
  ...
  return (
    <div className="ak-hero ak-style1 heignt-100vh">
      <Image width={1000} height={1000} className="ak-hero-bg ak-bg" src='/img/bg/hero_bg_1r.png' alt="..." />
      <div className="container mx-auto md:px-6 px-4">
        <div className="hero-text-section w-full px-4">
          <div className="ak-slider ak-slider-hero-1 md:pl-6 pl-2">
            <Swiper
              loop={true}
              slidesPerView={"auto"}
              onSwiper={(swiper) => {
                ...
                <SwiperSlide key={item.id}>
                  <div className="slider-info">
                    <div>
                      ...
                      <Link href={item.buttonUrl} className="hero-btn style-1">
                        <div className="hover:bg-[var(--brand-error)]/80 !text-white w-auto left-0 rounded-none bg-[var(--brand-error)] px-9 py-[18px] outline-none cursor-pointer inline-block text-[18px] border-none uppercase transition-all duration-300 border-transparent">{item.buttonText}</div>
                      </Link>
                    </div>
        ...
        <div className="ak-swiper-controll-hero-1">
          <div className="ak-swiper-navigation-wrap">
            <div
              className="hero-swiper-prev -left-[35px] lg:left-[0px]"
            ...
            <div
              className="hero-swiper-next -left-[35px] lg:left-[0px] "
