...
type Props = {
  props?: {
    popularcategorylis?: string[];
    populartag?: string[];
  } | undefined;
};

export default function SideBarBlogDetails({ props }: Props) {
  return (
    <>
      ...
      <div>
        ...
        <div className="category-list">
          {(props?.popularcategorylis ?? []).map((elem: string, i: number) => (
            <Link href="#" key={i}>
              {elem}
            </Link>
          ))}
      ...
      <div className="popular-tag">
        {(props?.populartag ?? []).map((elem: string, i: number) => (
          <Link href="#" key={i}>
            {elem}
          </Link>
        ))}
      ...
      <div className="author-info">
        ...
        <div className="flex justify-start space-x-4">
          <Link href="https://www.facebook.com/" className="author-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="8"
            height="15"
        ...
        <Link href="https://twitter.com/?lang=en" className="author-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="19"
            height="15"
        ...
        <Link href="https://bd.linkedin.com/" className="author-icon">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="17"
            height="17"
