...
export default function BookingSystem({ styleTwo }: Props) {
  const [inputs, setInputs] = useState<{ option?: string; time?: string; date?: string }>({});
  ...
  return (
    <div className="booking-system-form">
      <form className={bookingStyle} onSubmit={handleSubmit}>
        ...
        <SubmitButton className="max-h-[60px]">
          Reservations
        </SubmitButton>
      </form>
    </div>
